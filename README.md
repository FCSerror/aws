...
- **Sat 8/22** — Compute: EC2 instance families, Lambda, Elastic Beanstalk, containers at a glance (ECS/EKS/Fargate). Storage: S3 storage classes, EBS vs. EFS, Storage Gateway, Snow Family (conceptual).
